               ...
               <Row>
                  <Col sm='12'>
                     <div className="iq-card">
                        ...
                        <div className="iq-card-body">
                           <p>Traditional heading elements are desined to work best in the meat of your page content. When you need a heading to stand out, consider using a <strong>display heading</strong>—a larger, slightly more opinionated heading style. Keep in mind these headings are not responsive by default, but it’s possible to enable <Link to="https://getbootstrap.com/" target="_blank">responsive font sizes</Link>.</p>
                  ...
                  <Col sm='12' lg='6'>
                     ...
                     <div className="iq-card">
                        ...
                        <div className="iq-card-body">
                           <p>Remove a list’s bullets and apply some light <code>margin</code> with a combination of two classNamees, <code>.list-inline</code> and <code>.list-inline-item</code>.</p>
                  ...
                  <Col sm='12' lg='6'>
                     <div className="iq-card">
                        ...
                        <div className="iq-card-body">
                           <p><code>.h1</code> through <code>.h6</code> classNamees are also available, for when you want to match the font styling of a heading but cannot use the associated HTML element.</p>
                     ...
                     <div className="iq-card">
                        ...
                        <div className="iq-card-body">
                           <p>Remove the default <code>list-style</code> and left margin on list items (immediate children only). <strong>This only applies to immediate children list items</strong>, meaning you will need to add the className for any nested lists as well.</p>
                  ...
                  <Col sm='12' >
                     <div className="iq-card">
                        ...
                        <div className="iq-card-body">
                           <p>Align terms and descriptions horizontally by using our grid system’s predefined classNamees (or semantic mixins). For longer terms, you can optionally add a <code>.text-truncate</code> className to truncate the text with an ellipsis.</p>
                           <dl className="row">
