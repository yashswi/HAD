                     ...
                     <div className="iq-card">
                        <div className="iq-card-body">
                           <Row className=" align-items-center">
                              <div className="col-6">
                                 <img src={logo} className="img-fluid avatar-80" alt="" />
                              </div>
                              <div className="col-6">
                              ...
                              <Col sm='12'>
                                 <hr className="mt-3" />
                                 <h5 className="mb-0">Hello, Bini Jetss</h5>
                           ...
                           <div className="row">
                              ...
                              <Col sm='6' className="col-sm-6 text-end">
                                 <button type="button" className="btn btn-link text-primary me-3"><i className="ri-printer-line"></i> Download Print</button>
